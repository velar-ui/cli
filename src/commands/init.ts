...
import { findMainCss, hasTailwindImport, ensureDir, injectVelarImport } from '../utils/css.js';
...
export default function registerInitCommand(program: Command) {
    program
        ...
        .action(async () => {
            ...
            console.log('✔ UI components directory ready');
            console.log(importDone ? '✔ Styles import complete' : '✔ Styles import pending');
            console.log('✔ velar.json created');
            console.log('\nNext steps:');
